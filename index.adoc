...
image::hpexels.png[Montanha,600,600,title="Imagem original"]

Abaixo o resultado do código com P1 = (250, 120) e P2 = (520, 520):

image::https://github.com/paivaneto8190/paivaneto8190.github.io/blob/main/Ex1/negativo.png[Montanha,600,600,title="Imagem negativa"]
